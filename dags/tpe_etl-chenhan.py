...
with DAG(
    ...
    sample = GKEPodOperator(
        ...
        image_pull_policy="Always",
        cmds=["echo"],
        arguments=["{{next_execution_date}}"],
    )

    drop = DummyOperator(task_id="drop", dag=dag)
    ...
    # create view
    update_schema = DummyOperator(task_id="update_schema", dag=dag)
    dummy >> update_schema >> mango_channel_mapping
